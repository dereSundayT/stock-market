          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (res.data.status === 'success') {
                  _this.msg = res.data.message; //client  stock

                  _this.mystocks = res.data.data; //array of stocks on the system

                  _this.stocks = res.data.stocks; //client's detail

                  _this.userDetails = res.data.user; //client overall summary of purchased stock
              ...
              case 8:
                ...
                _this.msg = _this.formatErrorResponse(_context.t0);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!(_this2.new_amount <= 0)) {
                  _context2.next = 7;
                  break;
                }

                _this2.msg = "Amount field is required/Amount cant be Zero";
              ...
              case 19:
                ...
                _this2.msg = _this2.formatErrorResponse(_context2.t0);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!(_this3.volume > 0 && _this3.selected > 0)) {
                  _context3.next = 16;
                  break;
                }
                ...
                _context3.prev = 4;
                _context3.next = 7;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/api/v1/virtual-investment', data);
              ...
              case 11:
                ...
                _this3.msg = _this3.formatErrorResponse(_context3.t0);
              ...
              case 16:
                _this3.msg = 'All fields are required';
                _this3.snackbar = true;
                _this3.loading = false;
